...
def get_metadata(driver):
    ...
    try:
        if hasattr(pe.resources_manager, 'version'):
        ...
        if driver_yaml['KnownVulnerableSamples']:
            for sample in driver_yaml['KnownVulnerableSamples']:
                ...
                if enrich:
                    ...
                    sample['Description'] = metadata_.get('FileDescription', '')
                    sample['Company'] = metadata_.get('CompanyName', '')
                    sample['InternalName'] = metadata_.get('InternalName','')
                    sample['OriginalFilename'] = metadata_.get('OriginalFilename', '')
                    sample['FileVersion'] = metadata_.get('FileVersion', '')
                    sample['Product'] = metadata_.get('ProductName', '')
                    sample['ProductVersion'] = metadata_.get('ProductVersion', '')
                    sample['Copyright'] = metadata_.get('LegalCopyright', '')
