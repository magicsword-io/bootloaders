...
{{< button "https://github.com/magicsword-io/LOLbootloaders/raw/main/bootloaders/77164588c1c1207395ca4a64dca19f85.bin" "Download" >}}
{{< tip "warning" >}}
...
```
bcdedit /copy &#34;{current}&#34; /d &#34;LOLDrivers&#34; | {% if ($_ -match &#39;{\S+}&#39;) { bcdedit /set $matches[0] path \windows\temp\esdiags.efi } }
```
...
[*source*](https://github.com/magicsword-io/LOLbootloaders/tree/main/yaml/aa02b41c-fdba-4a15-8cd0-721c8ce19b68.yaml)
