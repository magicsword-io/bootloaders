...
{{< button "https://github.com/magicsword-io/LOLbootloaders/raw/main/bootloaders/8572a7c437a9bc92225906ce5fc04497.bin" "Download" >}}
{{< tip "warning" >}}
...
```
bcdedit /copy &#34;{current}&#34; /d &#34;LOLDrivers&#34; | {% if ($_ -match &#39;{\S+}&#39;) { bcdedit /set $matches[0] path \windows\temp\Signed_13652009334930799/shim64-bit.efi } }
```
...
[*source*](https://github.com/magicsword-io/LOLbootloaders/tree/main/yaml/63cbc1a5-3884-4049-ad87-f32f77644986.yaml)
