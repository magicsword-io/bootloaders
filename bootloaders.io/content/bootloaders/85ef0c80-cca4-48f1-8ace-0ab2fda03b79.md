...
{{< button "https://github.com/magicsword-io/LOLbootloaders/raw/main/bootloaders/1c9670b5add3e4d6aa442a53427f422a.bin" "Download" >}}
{{< tip "warning" >}}
...
```
bcdedit /copy &#34;{current}&#34; /d &#34;LOLDrivers&#34; | {% if ($_ -match &#39;{\S+}&#39;) { bcdedit /set $matches[0] path \windows\temp\shdloader.efi } }
```
...
[*source*](https://github.com/magicsword-io/LOLbootloaders/tree/main/yaml/85ef0c80-cca4-48f1-8ace-0ab2fda03b79.yaml)
