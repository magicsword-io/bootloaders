...
{{< button "https://github.com/magicsword-io/LOLbootloaders/raw/main/bootloaders/22f93e6ecea58e543fcffa73f5c466b3.bin" "Download" >}}
{{< tip "warning" >}}
...
```
bcdedit /copy &#34;{current}&#34; /d &#34;LOLDrivers&#34; | {% if ($_ -match &#39;{\S+}&#39;) { bcdedit /set $matches[0] path \windows\temp\Signed_13652009334930799/shimia32.efi } }
```
...
[*source*](https://github.com/magicsword-io/LOLbootloaders/tree/main/yaml/3cd9faa5-1675-4640-8304-86e162b60451.yaml)
